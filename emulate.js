...
async function AC12_65305 () {
  switch (emulate) {
    case 'standby':
        messages = [ "%s,7,65305,%s,255,8,41,9f,00,02,02,00,00,00",
             "%s,7,65305,%s,255,8,41,9f,00,0a,0a,00,80,00" ];
        break;
    case 'NFU':
        messages = [ "%s,7,65305,%s,255,8,41,9f,00,1d,01,00,00,00",
        ...
        break;
    case 'auto':
        messages = [ "%s,7,65305,%s,255,8,41,9f,00,1d,80,00,00,00",
                     "%s,7,65305,%s,255,8,41,9f,00,02,10,00,00,00",
      ...
      case 'AC12':
        ...
        // Seatalk1 pilot mode
          ...
          if (pilotmode126720.length > 24) { // We have 4 parts now
              ...
              } else if (Seatalkmode.match(/16,3b,9f,f0,81,84,..,..,..,4646,,/)) {
                if (pilot_state != 'wind') {
        ...
        // B&G autopilot buttons
        } else if (msg.pgn.pgn == 130850) {
